...
from Utils import net, read_config, select_things, eval_utils, reader
...
def main(FLAGS):
    ...
    boxes_labels = eval_utils.label_extractor(scale[0])

    bdboxes = eval_utils.get_bdboxes(boxes_labels)
