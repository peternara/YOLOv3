...
import numpy as np
from Utils import net, read_config, get_loss, select_things, reader
...
def main(FLAGS):
    ...
    labels_fienames = reader.get_labels(FLAGS.batch_size, FLAGS.labels_path)
    normalize_labels = reader.extract_labels.labels_normalizer(labels_fienames,
                                                        FLAGS.width,
                                                        FLAGS.height,
                                                        scale_width,
                                                        scale_height)
